...
import ameba.aeromock.config.{ConfigHolder, ServerOptionRepository}
import ameba.aeromock.core.builtin.BuiltinVariableHelper
import ameba.aeromock.core.http.{Endpoint, ParsedRequest, RequestManager}
import ameba.aeromock.data._
import ameba.aeromock.helper._
import ameba.aeromock.server.http.{CustomResponse, RenderResult, ResponseStatusSupport}
import ameba.aeromock.util.DummyWriter
import ameba.aeromock.{AeromockLoadDataException, AeromockNoneRelatedDataException, AeromockRenderException, AeromockSystemException}
...
abstract class TemplateService extends AnyRef with ResponseStatusSupport {
  ...
  /**
   * Create [[ameba.aeromock.data.InstanceProjection]]
   * @param project [[ameba.aeromock.config.entity.Project]]
   * @param request [[ameba.aeromock.core.http.ParsedRequest]]
   * @return [[ameba.aeromock.data.InstanceProjection]]
   */
