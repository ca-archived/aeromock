 ...
 * @author stormcat24
 */
class VelocityTemplateServiceSpec extends Specification with Tables with SpecSupport {

  "render" should {
    "tutorial" in {
      implicit val module = new AeromockTestModule {
        override val projectConfigPath: Path = getResourcePath(".").resolve("../../../../tutorial/velocity/project.yaml").toRealPath()
