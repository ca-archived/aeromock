...
import ameba.aeromock.cli.report.junit.TestsuiteFactory
import ameba.aeromock.cli.{CliJob, Job}
import ameba.aeromock.config.entity.Project
import ameba.aeromock.core.http.Endpoint
import ameba.aeromock.helper._
import ameba.aeromock.template.{DataAsserts, PageValidation, TemplateContexts, TemplateService}
 ...
 * @author stormcat24
 * @param operation [[ameba.aeromock.cli.option.JobOperation]]
 */
...
class ViewCheckJob(operation: JobOperation, project: Project,
  ...
  override def execute(): Int = {
    ...
    import ameba.aeromock.template.AssertionResultType._
